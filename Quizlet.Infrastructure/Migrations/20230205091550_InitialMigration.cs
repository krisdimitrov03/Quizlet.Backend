    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersFavoriteQuizes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersFavoriteQuizes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersFavoriteQuizes_Quizes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quizes_ImageId",
                table: "Quizes",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersFavoriteQuizes_QuizId",
                table: "UsersFavoriteQuizes",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersFavoriteQuizes_UserId",
                table: "UsersFavoriteQuizes",
                column: "UserId");
        }
